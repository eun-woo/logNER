...
"mac.jsonlines", "openssh.jsonlines", "openstack.jsonlines", "proxifier.jsonlines", "spark.jsonlines", "thunderbird.jsonlines", "zookeeper.jsonlines"]


with open("union_datasets.jsonlines", "w") as wf:
