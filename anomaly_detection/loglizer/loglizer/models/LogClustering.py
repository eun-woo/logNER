...
class LogClustering(object):
    ...
    def predict(self, X, y_true):
        ...
        # 디버깅 시
        ############ Debuging ###################################
        print('min_dist : ', min_dist_seq)
        print('max_dist: ', self.max_dist)
        print('anomaly threshold: ', self.anomaly_threshold)
        print('y_true: ', "[" + ", ".join(list(map(str, y_true))) + "]")
        print('y_pred: ', "[" + ", ".join(list(map(str, y_pred))) + "]")
        #########################################################
        return y_pred
