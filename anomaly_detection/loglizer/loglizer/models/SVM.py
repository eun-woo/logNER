...
class SVM(object):
    ...
    def __init__(self, penalty='l1', tol=0.1, C=1, dual=False, class_weight=None, 
        ...
        # self.classifier = svm.SVC(decision_function_shape='ovo', tol=tol, C=C, class_weight=class_weight, max_iter=max_iter, kernel='linear')
        # self.classifier = svm.NuSVC(nu=0.2, decision_function_shape='ovo', tol=tol, class_weight=class_weight, max_iter=max_iter, kernel='rbf')
    def fit(self, X, y):
        """
        Arguments
        ---------
    ...
    def evaluate(self, X, y_true):
        ...
        print(('\033[32m' + 'Precision: {:.3f}, recall: {:.3f}, F1-measure: {:.3f}\n' + '\033[0m').format(precision, recall, f1))
